...
Conversely, if even a single field fails to validate, Couch makes available to your code each field that failed validation. Thus if two fields named _name_ and _password_ did not validate, two variables named *k\_error\_name* and *k\_error\_password* will become available in the context of the parent form. These variables will contain the relavent error messages.<br/>
...
The *reload\_text* parameter can be used to change the 'Reload Image' text to anything you wish.<br/>
