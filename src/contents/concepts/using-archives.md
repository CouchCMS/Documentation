...
::: .notice
The *k\_archive\_date* variable is set in a machine readable format.
...
The *k\_archive\_link* variable set by the archives tag points to this view for each time period.
Thus for a monthly period of July, 2010, the link of the _archive-view_ of _blog.php_ could be -
...
In this view, apart from other variables that you normally find set, Couch sets the *k\_archive\_date* and *k\_next\_archive\_date* variables (see: [**Variables available in Views**](./variables-in-views.html)).
