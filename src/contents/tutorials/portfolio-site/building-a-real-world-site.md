...
The template we have chosen to do so is Aurelius.[<img alt="" src="../../assets/img/contents/download.png" style="border: 0; float: right;"/>](https://www.couchcms.com/docs/code/Aurelius.zip)
