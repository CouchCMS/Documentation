---
title: Changelog
description: Learn about the changes in each version of CouchCMS.
keywords:
    - CouchCMS
    - changelog
    - web design
...
This changelog requires updates to include the additional features we have implemented since 2016. We will update this as we release new versions of CouchCMS.
...
- Fix security issues
    - [http://seclists.org/fulldisclosure/2015/Dec/110](http://seclists.org/fulldisclosure/2015/Dec/110)
    - [http://seclists.org/fulldisclosure/2015/Dec/111](http://seclists.org/fulldisclosure/2015/Dec/111)
...
- Added the ability to create Shortcodes ([http://docs.couchcms.com/miscellaneous/shortcodes.html](http://docs.couchcms.com/miscellaneous/shortcodes.html))

    - This is the first of several steps meant to open up Couch's architecture to allow extenting it with external code

- Added support for Nested Pages ([http://docs.couchcms.com/concepts/nested-pages-aka-menu-maker.html](http://docs.couchcms.com/concepts/nested-pages-aka-menu-maker.html))
...
- Upgraded CKEditor to version 3.5.4
    ...
    - Language files may be downloaded from [http://www.couchcms.com/ckeditor_354_lang.zip](http://www.couchcms.com/ckeditor_354_lang.zip)
...
- CKEditor
    ...
    - Added CKEditor language files:
        ...
        - `DE`
        - `FR`
        - The rest can be downloaded from [http://www.couchcms.com/ckeditor_lang.zip](http://www.couchcms.com/ckeditor_lang.zip)
