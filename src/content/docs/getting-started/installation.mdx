---
title: Installation
description: "Step-by-step installation guide for CouchCMS including file upload, database configuration, admin account setup, and initial configuration steps."
keywords:
    - CouchCMS
    - installation guide
    - server requirements
...
import portfolioSite5 from '../../../assets/img/contents/portfolio-site-5.jpg';
import portfolioSite6 from '../../../assets/img/contents/portfolio-site-6.jpg';
import portfolioSite7 from '../../../assets/img/contents/portfolio-site-7.jpg';
import portfolioSite8 from '../../../assets/img/contents/portfolio-site-8.png';
...
2. You'll see the CouchCMS installation screen. Couch will sense that installation is required and will display the following form for you to fill:
    ...
    <Image src={portfolioSite5} alt="Portfolio Site Example" />
...
3. Enter your desired name, password and email address. Press install and in a little while you should be prompted with the following screen:
    ...
    <Image src={portfolioSite6} alt="Portfolio Site Example" />
    > Portfolio Site Example
 ...
 4. Login using the super-admin account you created and brace yourself for facing the most 'barren' admin section you'll ever come across:
    ...
    <Image src={portfolioSite7} alt="Portfolio Site Example" />
    > Portfolio Site Example
    ...
    <Image src={portfolioSite8} alt="Portfolio Site Example" />
    > Portfolio Site Example
