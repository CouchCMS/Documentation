---
title: Relationships
description: "Complete guide to establishing and managing relationships between pages in CouchCMS including one-to-one, one-to-many, and many-to-many patterns."
keywords:
    - relationships
    - many-to-many
    - one-to-many
...
import relationships1 from '../../../assets/img/contents/relationships-1.png';
import relationships2 from '../../../assets/img/contents/relationships-2.png';
import relationships3 from '../../../assets/img/contents/relationships-3.png';
import relationships4 from '../../../assets/img/contents/relationships-4.png';
...
To define a relationship between the two templates, we use a new type of editable region introduced by Couch v1.3 - [**relation**](../../tags-reference/core/editable/relation/).
...
<Image src={relationships1} alt="Album Selection Interface" />

> Interface showing the list of available albums that can be associated with an artist

:::tip[Relationship Control]
By default, all the pages of the related template are shown in the list. We can exert some control over which pages get listed (and how) by using the following parameters of the 'editable' tag of type [**relation**](../../tags-reference/core/editable/relation/):

- [**folder**](../../tags-reference/core/editable/relation/#parameters)
- [**include_subfolders**](../../tags-reference/core/editable/relation/#parameters)
- [**orderby**](../../tags-reference/core/editable/relation/#parameters)
- [**order_dir**](../../tags-reference/core/editable/relation/#parameters)
:::
...
<Image src={relationships2} alt="One-to-Many Selection Interface" />
...
<Image src={relationships3} alt="Many-to-One Selection Interface" />
...
<Image src={relationships4} alt="One-to-One Selection Interface" />
...
- [**related_pages**](../../tags-reference/core/related_pages/)
- [**reverse_related_pages**](../../tags-reference/core/reverse_related_pages/)
...
The `related_pages` and `reverse_related_pages` tags are almost identical to the [**pages**](../../tags-reference/core/pages/) tag we know so well. Just like the [**pages**](../../tags-reference/core/pages/) tag, these two tags also make available all the variables associated with the (related) page being iterated. They also support almost [all the parameters](../../tags-reference/core/pages/#parameters) that the [**pages**](../../tags-reference/core/pages/) tag supports.
