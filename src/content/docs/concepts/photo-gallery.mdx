---
title: Photo Gallery
description: "Complete tutorial on creating and managing photo galleries in CouchCMS with batch image upload, EXIF data extraction, and automatic thumbnails."
keywords:
    - photo gallery
    - image upload
    - gallery management
...
import photoGallery1 from '../../../assets/img/contents/photo-gallery-1.gif';
import photoGallery2 from '../../../assets/img/contents/photo-gallery-2.gif';
import photoGallery3 from '../../../assets/img/contents/photo-gallery-3.gif';
import photoGallery4 from '../../../assets/img/contents/photo-gallery-4.gif';
import photoGallery5 from '../../../assets/img/contents/photo-gallery-5.gif';
import photoGallery6 from '../../../assets/img/contents/photo-gallery-6.jpg';
import photoGallery7 from '../../../assets/img/contents/photo-gallery-7.jpg';
...
<Image src={photoGallery1} alt="Gallery Upload Interface" />
...
<Image src={photoGallery2} alt="Gallery Batch Upload" />
...
<Image src={photoGallery3} alt="Gallery Upload Progress" />
...
<Image src={photoGallery4} alt="Gallery Admin View" />
...
<Image src={photoGallery5} alt="Gallery Edit Panel" />
...
For gallery pages, the [**cms:pages**](../../tags-reference/core/pages/) tag also recognizes the following new values for the `orderby` parameter. These can be helpful in ordering the listing of images according to the meta data of the images.
...
<Image src={photoGallery6} alt="Gallery Layout" />
> Basic gallery example

<Image src={photoGallery7} alt="Gallery Slimbox" />
