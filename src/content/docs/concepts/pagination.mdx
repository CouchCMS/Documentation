---
title: Pagination
description: "Comprehensive guide to implementing pagination in CouchCMS for pages, search results, and comments with navigation controls and page numbering."
keywords:
    - pagination
    - pages
    - search results
...
import paginationImg from '../../../assets/img/contents/pagination.png';

The [**pages**](../../tags-reference/core/pages/), [**search**](../../tags-reference/core/search/) and [**comments**](../../tags-reference/core/comments/) tags can fetch more items than specified by the `limit` parameter. In such cases, it's common to display items in a paginated manner - split across several pages with navigation buttons. These tags provide several variables that help implement pagination.
...
While we use the [**pages**](../../tags-reference/core/pages/) tag in examples, all pagination variables work identically with [**search**](../../tags-reference/core/search/) and [**comments**](../../tags-reference/core/comments/) tags.
:::
...
Instead of manually coding the 'next' and 'prev' buttons for navigating through the pages, use the [**paginator**](../../tags-reference/core/paginator/) tag for a more polished look:
...
If the [**paginator**](../../tags-reference/core/paginator/) tag is used to generate the navigation buttons, the following
...
<Image src={paginationImg} alt="Paginator Example" />
