---
title: Views
description: "Complete guide to understanding CouchCMS views including List View, Page View, Folder View, and Archive View with URL patterns and content display."
keywords:
    - views
    - list view
    - page view
