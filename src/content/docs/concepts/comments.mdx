---
title: Comments
description: "Comprehensive guide to enabling user comments on CouchCMS pages including comment forms, spam prevention with CAPTCHA, moderation workflow, and comment listing."
keywords:
    - comments
    - user comments
    - comment form
...
:::caution[About Forms]
The following discussion about the comment form assumes that you are already familiar with the [**form**](../../tags-reference/core/form/) tag which is used to create it.
:::
...
On successful submission of the form, the [**process_comment**](../../tags-reference/core/process_comment/) Couch tag can be invoked to process the submitted comment and save it into the database.
...
The above snippet can be saved into a file named, for example, `comment-form.inc` within the snippets folder and then be used in any template by using the [**embed**](../../tags-reference/core/embed/) tag:
...
On successful submission of the form (`k_success`), we simply invoke the [**process_comment**](../../tags-reference/core/process_comment/) tag.
...
The [**comments**](../../tags-reference/core/comments/) tag is used to list comments based on the parameters passed to it.
It is closely related to the [**pages**](../../tags-reference/core/pages/) tag and hence shares several of the [**parameters**](../../tags-reference/core/pages/#parameters) accepted by the pages tag.
...
Normally [**comments**](../../tags-reference/core/comments/) tag will fetch all the available approved comments.
...
Please see: [**comments**](../../tags-reference/core/comments/#parameters) for a complete list of parameters that are accepted by this tag and how they can be used.

### Example

As an example of the [**comments**](../../tags-reference/core/comments/) tag, the following is a real world snippet that when placed in a template, shows the comments belonging to the cloned page that is currently displayed.
Notice the use of the variable `k_page_id` (always set by Couch to the id of the current page in *page-view*) to constrain the `comments` tag to fetch only comments belonging to the current page. Also notice the use of the [**gravatar**](../../tags-reference/core/gravatar/) tag.
