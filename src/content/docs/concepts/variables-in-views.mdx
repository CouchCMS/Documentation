...
:::tip[Debug Variables]
You can use the Couch tags [**dump**](../../tags-reference/core/dump/) and [**dump_all**](../../tags-reference/core/dump_all/) to see for yourself all the variables with their current values.
:::
