...
One such pattern is the 'decorator' pattern. You can find a discussion on it at [**Advanced Tutorial - Views**](../../tutorials/advanced-tutorial/views/) where we use it in our 'Advanced tutorial'.
