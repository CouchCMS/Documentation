...
It extends the existing commenting functionality in Couch (as documentated at [http://www.couchcms.com/docs/concepts/u ... ments.html](http://www.couchcms.com/docs/concepts/u ... ments.html)) so I assume we have a registered template (`blog.php`) that is already configured to
