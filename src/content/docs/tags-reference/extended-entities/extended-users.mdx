...
Much of what I say here would be a repetition of what has already been said in the documentation for the [**members**](https://www.couchcms.com/forum/viewtopic.php?f=5&t=8063) addon. This should be understandable as **Extended Users** addon is meant to be an official replacement for the 'members' addon and provides exactly the same functions (albeit the tag names are slightly different).
...
:::caution[Default user / super-admin]
