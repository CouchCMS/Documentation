...
The **get** tag is used to output the value of the variable the name of which is supplied to it as its parameter. For example:
...
In the snippet given above, `my_var` is the name of the variable the value of which is output by the **get** tag. The output of the snippet is `10`.
