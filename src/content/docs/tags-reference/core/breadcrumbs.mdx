...
title: breadcrumbs
category: tag
description: "Documentation for the breadcrumbs tag that outputs the folder hierarchy navigation trail for the current page or folder with customizable separators."
keywords:
    - breadcrumbs
    - CouchCMS
    - Couch
...
Please see [**Core Concepts - Folders**](../../../../concepts/folders/) for a discussion on this tag's usage.
