...
The **excerptHTML** tag can be used to create an excerpt of any HTML content that is enclosed within its opening and closing tags. Unlike the [**excerpt**](../excerpt/) tag, excerptHTML preserves the HTML formatting of the truncated contents (except for the HTML tags specified in its `ignore` parameter).
...
The HTML elements to weed out of the excerpt. For example, you might not want to have any images in the excerpt. If you wish to ignore multiple tags, separate the tagnames by using comma e.g.:
