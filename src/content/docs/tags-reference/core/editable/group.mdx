...
import groupImg1 from '../../../../../assets/img/contents/editable-group-1.gif';
import groupImg2 from '../../../../../assets/img/contents/editable-group-2.gif';
...
<Image src={groupImg1} alt="Editable regions in admin panel" />
...
<Image src={groupImg2} alt="Grouped editable regions" />
