...
import img1 from '../../../../../assets/img/contents/editable-image-1.gif';
import img2 from '../../../../../assets/img/contents/editable-image-2.jpg';
import img3 from '../../../../../assets/img/contents/editable-image-3.jpg';
import img4 from '../../../../../assets/img/contents/editable-image-4.jpg';
import img5 from '../../../../../assets/img/contents/editable-image-5.jpg';
import img6 from '../../../../../assets/img/contents/editable-image-6.jpg';
import img7 from '../../../../../assets/img/contents/editable-image-7.jpg';
import img8 from '../../../../../assets/img/contents/editable-image-8.jpg';
import img9 from '../../../../../assets/img/contents/editable-image-9.jpg';
import img10 from '../../../../../assets/img/contents/editable-image-10.jpg';
import img11 from '../../../../../assets/img/contents/editable-image-11.jpg';
import img12 from '../../../../../assets/img/contents/editable-image-12.jpg';
import img13 from '../../../../../assets/img/contents/editable-image-13.jpg';
import img14 from '../../../../../assets/img/contents/editable-image-14.jpg';
import img15 from '../../../../../assets/img/contents/editable-image-15.jpg';
import img16 from '../../../../../assets/img/contents/editable-image-16.jpg';
import img17 from '../../../../../assets/img/contents/editable-image-17.jpg';
import img18 from '../../../../../assets/img/contents/editable-image-18.jpg';
import img19 from '../../../../../assets/img/contents/editable-image-19.jpg';
import img20 from '../../../../../assets/img/contents/editable-image-20.jpg';
import img21 from '../../../../../assets/img/contents/editable-image-21.jpg';
import img22 from '../../../../../assets/img/contents/editable-image-22.jpg';
import img23 from '../../../../../assets/img/contents/editable-image-23.jpg';
import img24 from '../../../../../assets/img/contents/editable-image-24.jpg';
import img25 from '../../../../../assets/img/contents/editable-image-25.jpg';
import img26 from '../../../../../assets/img/contents/editable-image-26.jpg';
import img27 from '../../../../../assets/img/contents/editable-image-27.jpg';
import img28 from '../../../../../assets/img/contents/editable-image-28.jpg';
import img29 from '../../../../../assets/img/contents/editable-image-29.jpg';
import img30 from '../../../../../assets/img/contents/editable-image-30.jpg';
...
<Image src={img1} alt="Image upload interface showing browse and upload options" />
...
|:---|:---|
| <Image src={img2} alt="300 x 200" /> | <Image src={img3} alt="150 x 100" /> |
...
|:---|:---|
| <Image src={img4} alt="200 x 300" /> | <Image src={img5} alt="150 x 225" /> |
| **Uploaded Image** | **Saved Image** |
|  | The width constrained to 150px, height scaled proportionally |
...
|:---|:---|
| <Image src={img6} alt="100 x 75" /> | <Image src={img7} alt="100 x 75" /> |
| **Uploaded Image** | **Saved Image** |
...
| Before (300 x 200) | After (150 x 100) |
|:---|:---|
| <Image src={img8} alt="Uploaded Image" /> | <Image src={img9} alt="Saved Image" /> |
| **Uploaded Image** | **Saved Image** |
...
|:---|:---|
| <Image src={img10} alt="Uploaded Image" /> | <Image src={img11} alt="Saved Image" /> |
| **Uploaded Image** | **Saved Image** |
...
| Before (100 x 75) | After (100 x 75) |
|:---|:---|
| <Image src={img12} alt="Uploaded Image" /> | <Image src={img13} alt="Saved Image" /> |
| **Uploaded Image** | **Saved Image** |
...
|:---|:---|
| <Image src={img14} alt="Uploaded Image" /> | <Image src={img15} alt="Saved Image" /> |
| **Uploaded Image** | **Saved Image** |
...
| Before (300 x 200) | After (150 x 100) |
|:---|:---|
| <Image src={img16} alt="Uploaded Image" /> | <Image src={img17} alt="Saved Image" /> |
| **Uploaded Image** | **Saved Image** |
...
| Before (200 x 300) | After (150 x 225) |
|:---|:---|
| <Image src={img18} alt="Uploaded Image" /> | <Image src={img19} alt="Saved Image" /> |
| **Uploaded Image** | **Saved Image** |
...
|:---|:---|
| <Image src={img20} alt="Uploaded Image" /> | <Image src={img21} alt="Saved Image" /> |
| **Uploaded Image** | **Saved Image** |
...
|:---|:---|
| <Image src={img22} alt="Uploaded Image" /> | <Image src={img23} alt="Saved Image" /> |
| **Uploaded Image** | **Saved Image** |
...
| Before (200 x 300) | After (150 x 150) |
|:---|:---|
| <Image src={img24} alt="Uploaded Image" /> | <Image src={img25} alt="Saved Image" /> |
| **Uploaded Image** | **Saved Image** |
|  | The image is proportionately scaled until one of the two dimensions is _equal_ to the required value and the other is either _equal or larger_ than the required value. In case the other dimension is larger, the surplus area is cropped off. |
...
|:---|:---|
| <Image src={img26} alt="Uploaded Image" /> | <Image src={img27} alt="Saved Image" /> |
| **Uploaded Image** | **Saved Image** |
|  | The image is proportionately scaled until one of the two dimensions is _equal_ to the required value and the other is either _equal or larger_ than the required value. In case the other dimension is larger, the surplus area is cropped off. |
...
<Image src={img28} alt="Preview of selected image" />
...
<Image src={img29} alt="Preview of selected image" />
...
<Image src={img30} alt="Preview of selected image" />
