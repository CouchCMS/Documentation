...
This parameter sets the `action` parameter of the generated form. This needs to be set to the URL of the page that has the **pages** tag on it. If left empty, the **pages** tag is expected to be on the same page as the **search_form** tag.
