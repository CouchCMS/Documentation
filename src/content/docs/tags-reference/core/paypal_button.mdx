...
import paypalButton from '../../../../assets/img/contents/paypal_button.png';

Please see [**Core Concepts - PayPal**](../../../../concepts/paypal/) for a detailed discussion about this tag and its usage.
...
<Image src={paypalButton} alt="Paypal Button" />
