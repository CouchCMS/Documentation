...
description: "Learn how to validate and constrain route parameters in CouchCMS custom routes using validators, regex patterns, and parameter type checking."
keywords:
    - custom routes
    - validation
    - constraints
