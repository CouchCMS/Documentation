...
import subTemplates01 from '../../../../assets/img/contents/sub-templates-01.png';
import subTemplates02 from '../../../../assets/img/contents/sub-templates-02.png';
import subTemplates03 from '../../../../assets/img/contents/sub-templates-03.png';
import subTemplates04 from '../../../../assets/img/contents/sub-templates-04.png';
import subTemplates05 from '../../../../assets/img/contents/sub-templates-05.png';
import subTemplates06 from '../../../../assets/img/contents/sub-templates-06.png';
import subTemplates07 from '../../../../assets/img/contents/sub-templates-07.png';
import subTemplates08 from '../../../../assets/img/contents/sub-templates-08.png';
...
<Image src={subTemplates01} alt="Product Filter Example" />
...
3. Now define the sub-templates and allocate the fields to them:
    ...
    **b**. Editable region of type 'single_check'
    ...
    <Image src={subTemplates02} alt="Sub-templates dropdown" />
    ...
    <Image src={subTemplates03} alt="Sub-template selector dropdown" />
...
3. Declare our sub-templates.
    ...
    <Image src={subTemplates04} alt="Sub-template example" />
...
<Image src={subTemplates05} alt="Sub-templates Example" />
...
<Image src={subTemplates06} alt="Example of fields for Mobiles sub-template" />
> Example of fields for Mobiles sub-template
...
<Image src={subTemplates07} alt="Example of fields for saved page" />
> Example of fields for saved page
...
The dropdown selector for the sub-templates that you have already seen is actually a regular editable region of type 'relation' named '_sub_template'. You can use it with `<cms:pages>` the usual way (as documented at this [tread](https://www.couchcms.com/forum/viewtopic.php?f=5&t=8581) under '2. Enhanced cms:pages tag') e.g. as follows:
...
<Image src={subTemplates08} alt="Layered Navigation Example" />
