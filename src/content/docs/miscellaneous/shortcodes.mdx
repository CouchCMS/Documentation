---
title: "Shortcodes"
description: "Learn how to create and use shortcodes in CouchCMS to extend functionality with reusable content blocks, custom macros, and embedded widgets."
keywords:
    - shortcodes
    - macros
    - content management
