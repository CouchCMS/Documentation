...
description: "Step-by-step guide to migrating your CouchCMS site from development to production including database transfer, file sync, and configuration updates."
keywords:
    - migration
    - deployment
    - development
