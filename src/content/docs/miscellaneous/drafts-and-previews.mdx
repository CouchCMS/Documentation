...
description: "Learn how to create and manage draft versions of published pages in CouchCMS with preview functionality before making content live on your website."
keywords:
    - drafts
    - previews
    - content management
...
import drafts1 from '../../../assets/img/contents/drafts-1.png';
import drafts2 from '../../../assets/img/contents/drafts-2.png';
import drafts3 from '../../../assets/img/contents/drafts-3.png';
import drafts4 from '../../../assets/img/contents/drafts-4.png';
import drafts5 from '../../../assets/img/contents/drafts-5.png';
import drafts6 from '../../../assets/img/contents/drafts-6.png';
...
<Image src={drafts1} alt="Creating a draft through Advanced Settings" />
> Creating a draft through Advanced Settings

A draft is actually a separate page in itself that has its data copied over from the original page.

<Image src={drafts2} alt="Draft page structure" />
...
<Image src={drafts3} alt="Drafts section in admin panel" />
> Drafts section in admin panel
...
<Image src={drafts4} alt="Draft access link" />
> Draft access link
...
<Image src={drafts5} alt="Draft preview options" />
...
<Image src={drafts6} alt="Publishing draft changes" />
