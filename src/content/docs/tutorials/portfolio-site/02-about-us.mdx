...
import portfolioSite11 from '../../../../assets/img/contents/portfolio-site-11.jpg';
import portfolioSite12 from '../../../../assets/img/contents/portfolio-site-12.png';
import portfolioSite17 from '../../../../assets/img/contents/portfolio-site-17.png';
import portfolioSite19 from '../../../../assets/img/contents/portfolio-site-19.png';
...
<Image src={portfolioSite11} alt="Admin Panel Showing About Template" />
> Admin Panel View
...
<Image src={portfolioSite12} alt="Editable Regions in About Us Page" />
> Editable Regions

### Main Content Region

Find the HTML block representing the main content region and surround it with Couch's [**editable**](../../../tags-reference/core/editable/) tags:
...
<Image src={portfolioSite17} alt="Admin Panel with Editable Regions" />
> Admin Panel View
...
:::note
The [**editable**](../../../tags-reference/core/editable/) tag, particularly the richtext type, has a plethora of options that you can set to tailor the created editable region to your client's need. Please refer to the [**Editable Regions**](../../../concepts/editable-regions/) for more information.
:::
...
Add the following line containing the [**template**](../../../tags-reference/core/template/) tag somewhere at the top of the page (below the boilerplate PHP include code):
...
<Image src={portfolioSite19} alt="Template Listed as About Us" />
> Updated Admin Panel
