---
title: The Home Page
description: "Step-by-step tutorial on implementing the home page in CouchCMS including featured portfolio carousel, content boxes, and dynamic content display."
keywords:
    - home page
    - portfolio
    - carousel
...
import portfolioSite181 from '../../../../assets/img/contents/portfolio-site-181.png';
import portfolioSite182 from '../../../../assets/img/contents/portfolio-site-182.png';
import portfolioSite185 from '../../../../assets/img/contents/portfolio-site-185.png';
import portfolioSite190 from '../../../../assets/img/contents/portfolio-site-190.png';
...
Add the two lines of boilerplate PHP code to enclose the contents of this file and use the [**template**](../../../../tags-reference/core/template/) tag to change the display-name of the template.
...
<Image src={portfolioSite181} alt="Home page layout with carousel and content boxes" />
> Aurelius home page with portfolio carousel and content sections
...
<Image src={portfolioSite182} alt="Four content boxes from the home page" />
> Content boxes with headings, descriptions and links
...
Create editable regions out of the marked regions by enclosing them with [**editable**](../../../../tags-reference/core/editable/) tags.
...
Also note that we have grouped together the editable regions belonging to each box by creating [**group**](../../../../tags-reference/core/editable/) type editable regions for each box and linking them to the regions.
...
<Image src={portfolioSite185} alt="Admin panel showing editable regions for home page" />
> Couch admin interface with home page editable regions
...
You must have guessed that we'll use the Couch [**pages**](../../../../tags-reference/core/pages/) tag to fetch the pages cloned from `portfolio.php` template. We'll proceed the way we have done several times while working with the enumerator tags ([**pages**](../../../../tags-reference/core/pages/), [**folders**](../../../../tags-reference/core/folders/), [**archives**](../../../../tags-reference/core/archives/)) in **Blog** and **Portfolio** sections -
...
<Image src={portfolioSite190} alt="Final home page with dynamic carousel" />
> Finished home page with portfolio items in carousel
