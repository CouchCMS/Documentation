...
As already explained at the outset of this tutorial, we are using the [**Extended Users**](../../../tags-reference/extended-entities/extended-users/) module  to implement the mentioned functionalities.
...
To put the rest of the functionalities in place, please refer to the [**Extended Users**](../../../tags-reference/extended-entities/extended-users/) documentation.
