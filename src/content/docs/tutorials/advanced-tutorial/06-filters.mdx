...
If, however, this page is found, the `cms:pages` tag has nothing within it to execute so it outputs a blank. Which translates to that this is a success case for this filter.
