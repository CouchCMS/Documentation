...
description: "Complete tutorial on CouchCMS Page Builder feature: create visual blocks, build dynamic pages with WYSIWYG editor, and offer flexible content management to clients."
keywords:
    - page builder
    - dynamic pages
    - editable regions
...
import pageBuilderCovers from '../../../../assets/img/contents/page-builder-covers.png';
import pageBuilderAbout from '../../../../assets/img/contents/page-builder-about.png';
import pageBuilder00 from '../../../../assets/img/contents/page-builder-00.png';
import pageBuilder01 from '../../../../assets/img/contents/page-builder-01.png';
import pageBuilder03 from '../../../../assets/img/contents/page-builder-03.png';
import pageBuilder04 from '../../../../assets/img/contents/page-builder-04.png';
import pageBuilder05 from '../../../../assets/img/contents/page-builder-05.png';
import pageBuilder06 from '../../../../assets/img/contents/page-builder-06.png';
import pageBuilder07 from '../../../../assets/img/contents/page-builder-07.png';
import pageBuilder08 from '../../../../assets/img/contents/page-builder-08.png';
import pageBuilder09 from '../../../../assets/img/contents/page-builder-09.png';
...
<Image src={pageBuilderCovers} alt="Page Builder Covers" />

```txt
http://test.local/about.html
```

<Image src={pageBuilderAbout} alt="Page Builder About" />
...
<Image src={pageBuilder00} alt="Page Builder 00" />
...
<Image src={pageBuilder01} alt="Page Builder 01" />
...
<Image src={pageBuilder03} alt="Page Builder 03" />
...
<Image src={pageBuilder04} alt="Page Builder 04" />

You should get something like this:

<Image src={pageBuilder05} alt="Page Builder 05" />
...
<Image src={pageBuilder06} alt="Page Builder 06" />
...
<Image src={pageBuilder07} alt="Page Builder 07" />
...
<Image src={pageBuilder08} alt="Page Builder 08" />
...
<Image src={pageBuilder09} alt="Page Builder 09" />
