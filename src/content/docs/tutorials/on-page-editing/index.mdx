...
description: "Complete tutorial on enabling and implementing on-page content editing in CouchCMS with inline WYSIWYG editing and visual content management."
keywords:
    - on-page editing
    - inline editing
    - content management
...
import onPageEditing1 from '../../../../assets/img/contents/on-page-editing-1.png';
import onPageEditing2 from '../../../../assets/img/contents/on-page-editing-2.png';
import onPageEditing7 from '../../../../assets/img/contents/on-page-editing-7.png';
import onPageEditing8 from '../../../../assets/img/contents/on-page-editing-8.png';
import onPageEditing9 from '../../../../assets/img/contents/on-page-editing-9.png';
import onPageEditing10 from '../../../../assets/img/contents/on-page-editing-10.png';
import onPageEditing11 from '../../../../assets/img/contents/on-page-editing-11.png';
import onPageEditing12 from '../../../../assets/img/contents/on-page-editing-12.png';
import onPageEditing13 from '../../../../assets/img/contents/on-page-editing-13.png';
import onPageEditing14 from '../../../../assets/img/contents/on-page-editing-14.png';
...
<Image src={onPageEditing1} alt="Miniport Template" />
...
<Image src={onPageEditing2} alt="Template Section" />
...
2. This second step is where all the fun happens. Here we'll add the tags that "inject" onpage editing to existing editable regions.
    ...
    <Image src={onPageEditing7} alt="Editable Regions" />
...
<Image src={onPageEditing8} alt="Popup Edit Link" />
...
<Image src={onPageEditing9} alt="Edit Popup" />
...
<Image src={onPageEditing10} alt="Button Edit" />
...
<Image src={onPageEditing11} alt="Multiple Regions" />
...
<Image src={onPageEditing14} alt="Final Edit Region" />
